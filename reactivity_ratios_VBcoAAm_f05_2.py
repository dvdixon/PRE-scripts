...
VBf05_1_df = pd.read_csv('VBcoAAM_r1r2_1.csv')
VBf05_2_df = pd.read_csv('VBcoAAM_r1r2_2.csv')
VBf03_1_df = pd.read_csv('VBcoAAM_r1r2_3.csv')
...
f10 = f1_data_VBf05_2[0]

r_fit, r_cov = curve_fit(fitfunc,x_data_VBf05_2,f1_data_VBf05_2,p0=[10.0,1.0],bounds=(0.0,np.inf),method='trf',xtol=1e-6)
print(r_fit)

rxn_data_1 = Data(x_data_VBf05_2,f1_data_VBf05_2)
model = Model(odrfitfunc)
odr = ODR(rxn_data_1, model, [10.0,1.0],maxit=100)
