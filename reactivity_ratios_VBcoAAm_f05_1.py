...
f10 = f1_data_VBf05_1[0]

r_fit, r_cov = curve_fit(fitfunc,x_data_VBf05_1,f1_data_VBf05_1,p0=[10.0,1.0],bounds=(0.0,np.inf),method='trf',xtol=1e-6)
print(r_fit)

rxn_data = Data(x_data_VBf05_1,f1_data_VBf05_1)
model = Model(odrfitfunc)
odr = ODR(rxn_data, model, [10.0,1.0],maxit=100)
