...
T = 323.15  # (K)
f = 0.8
rxn_time = 1.0 * 3600 # reaction time in seconds

# rate constants
kd = 8.2 * 10 ** -6  # (s-1) V-50
kp = 8.7 * 10 ** 4  # (L mol-1 s-1)
kt = 1.3 * 10 ** 7 # (L mol-1 s-1)
ktrM = 4.176  # (L mol-1 s-1) Odian p. 243
...
time = np.linspace(0, rxn_time, 500)
